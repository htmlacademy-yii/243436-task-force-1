    ...
    <ul class="menu-toggle__list">
        ...
        menu-toggle__item--completed">
            <div class="menu-toggle__svg-wrapper">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M0 10C0 4.47715 4.47715 0 10 0C12.6522 0 15.1957 1.05357 17.0711 2.92893C18.9464 4.8043 20
                        7.34784 20 10C20 15.5228 15.5228 20 10 20C4.47715 20 0 15.5228 0 10ZM9.73 13.61L14.3
                        7.61V7.58C14.5179 7.29419 14.5668 6.91382 14.4283 6.58218C14.2897 6.25054 13.9848 6.01801
                        13.6283 5.97218C13.2718 5.92635 12.9179 6.07419 12.7 6.36L8.92 11.36L7.29 9.28C7.07028 8.99776
        ...
        menu-toggle__item--active">
            <div class="menu-toggle__svg-wrapper">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M16 4.52L20.6 8.22C20.8463 8.4046 20.9938 8.6923 21 9V13C21 13.5523 20.5523 14 20
                        14H19.8C20.252 15.2453 19.8336 16.6396 18.7708 17.4304C17.7079 18.2212 16.2521 18.2212 15.1892
                        17.4304C14.1264 16.6396 13.708 15.2453 14.16 14H7.8C8.25289 15.2595 7.81666 16.6667 6.73074
                        17.4491C5.64482 18.2315 4.17193 18.2 3.12053 17.3717C2.06912 16.5435 1.69357 15.1189 2.2
                        13.88C1.45527 13.5552 0.981015 12.8122 0.999999 12V2C0.948749 0.955797 1.74653 0.0644265 2.79
                        0H14.19C15.2414 0.0538855 16.051 0.948426 16 2V4.52ZM19 12V9.48L16 7.08V12H19ZM6 15C6 15.5523
        ...
        menu-toggle__item--canceled">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M0 10C0 4.47715 4.47715 0 10 0C12.6522 0 15.1957 1.05357 17.0711 2.92893C18.9464 4.8043 20
                        7.34784 20 10C20 15.5228 15.5228 20 10 20C4.47715 20 0 15.5228 0 10ZM13.0058 12C13.0058 11.7334
                        12.8993 11.4778 12.71 11.29L11.41 10L12.71 8.71C13.1021 8.31788 13.1021 7.68212 12.71
                        7.29C12.3179 6.89788 11.6821 6.89788 11.29 7.29L10 8.59L8.71 7.29C8.31788 6.89788 7.68212
                        6.89788 7.29 7.29C6.89788 7.68212 6.89788 8.31788 7.29 8.71L8.59 10L7.29 11.29C7.10069 11.4778
                        6.9942 11.7334 6.9942 12C6.9942 12.2666 7.10069 12.5222 7.29 12.71C7.47777 12.8993 7.73336
        ...
        menu-toggle__item--hidden">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M18 3H6C4.76379 3.00732 3.65865 3.7722 3.21635 4.92661C2.77405 6.08101 3.08517 7.38852
                            4 8.22V18C4 19.6569 5.34315 21 7 21H17C18.6569 21 20 19.6569 20 18V8.22C20.9148 7.38852
                            21.226 6.08101 20.7837 4.92661C20.3414 3.7722 19.2362 3.00732 18 3ZM15 13.13C15 13.6105
        ...
        <?php if ($dataProvider->getModels()) : ?>
            <?php foreach ($dataProvider->getModels() as $task) : ?>
                <div class="new-task__card">
                    ...
                    <div class="task-status <?= $task->status === 'Выполнено' ? 'done-status' : 'new-status' ?>">
                        <?= $status === 'failed' ? 'Просрочено' : Html::encode($task->status); ?>
                    </div>
                    <p class="new-task_description">
                        <?= StringHelper::truncate(Html::encode($task->description), '138', '...'); ?>
                    </p>

                    <?php if ($task->status !== Task::STATUS_CANCEL && $task->status !== Task::STATUS_NEW) : ?>
                        <div class="feedback-card__top ">
                            <a href="<?= Url::to(['users/user', 'id' => $task->executor->id]) ?>">
                                <?= Html::img("@web/{$task->executor->path}", ['width' => 36, 'height' => 36]) ?>
                            </a>
                            <div class="feedback-card__top--name my-list__bottom">
                                ...
                                <?= $task->new_messages ? 'my-list__bottom-chat--new' : '' ?>">
                                    <b><?= Html::encode($task->new_messages); ?></b>
                                </a>
                                <?php $average_rating = $task->executor->getAverageRating(); ?>
